...
default_verdict = "approve" # the verdict the submit card opens on
...
| `default_verdict` | `comment` \| `approve` \| `request_changes` | `approve`  | the verdict the submit card opens on                                                                                                        |
