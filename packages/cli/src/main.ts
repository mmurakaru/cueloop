...
function printHelp(): void {
  console.log(
    [
      ...
      "",
      "scripting:",
      "  cueloop session <primitive> [flags]   script the daemon (create|get|list|wait|annotate|remove|cut|restore|curate|set-viewed|name-self|events|resolve|submit-revision)",
